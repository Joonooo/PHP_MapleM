...
$characterName = filter_input(INPUT_GET, 'character_name', FILTER_SANITIZE_STRING);
$worldName = filter_input(INPUT_GET, 'world_name', FILTER_SANITIZE_STRING);
...
// Nexon API 요청 URL 구성
$url = "https://open.api.nexon.com/maplestorym/v1/id?character_name=$characterName&world_name=$worldName";
